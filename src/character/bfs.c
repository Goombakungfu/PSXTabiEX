...
static const CharFrame char_bfs_frame[] = {
	...
	{bfs_ArcMain_Dead0, {  0,   0, 128, 119}, { 53,  118}}, //23 dead0 0
	{bfs_ArcMain_Dead0, {128,   0, 128, 123}, { 53,  118}}, //24 dead0 1
	{bfs_ArcMain_Dead0, {  0, 119, 128, 123}, { 53,  118}}, //25 dead0 2
	{bfs_ArcMain_Dead0, {128, 123, 128, 133}, { 53,  118}}, //26 dead0 3
	
	{bfs_ArcDead_Dead1, {  0,   0, 128, 123}, { 53,  118}}, //27 dead1 0
	{bfs_ArcDead_Dead1, {128,   0, 128, 123}, { 53,  118}}, //28 dead1 1
	{bfs_ArcDead_Dead1, {  0, 123, 128, 133}, { 53,  118}}, //29 dead1 2
	{bfs_ArcDead_Dead1, {128, 123, 128, 133}, { 53,  118}}, //30 dead1 3
	
	{bfs_ArcDead_Dead2, {  0,   0, 128, 128}, { 53,  118}}, //31 dead2 body twitch 0
	{bfs_ArcDead_Dead2, {128,   0, 128, 129}, { 53,  118}}, //32 dead2 body twitch 1
	{bfs_ArcDead_Dead2, {  0, 128, 128, 128}, { 53,  118}}, //33 dead2 balls twitch 0
	{bfs_ArcDead_Dead2, {128, 129, 128, 127}, { 53,  118}}, //34 dead2 balls twitch 1
};
...
Character *Char_bfs_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		"idle.tim",  //bfs_ArcMain_Idle
		"hit0.tim",  //bfs_ArcMain_Hit0
		"miss0.tim", //bfs_ArcMain_Miss0
		"hit1.tim",  //bfs_ArcMain_Hit1
		"miss1.tim", //bfs_ArcMain_Miss1
		"peace.tim", //bfs_ArcMain_Peace
